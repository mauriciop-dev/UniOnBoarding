...
1b. El 'element_selector' debe ser un selector CSS válido que funcione con querySelector. NUNCA uses clases de utilidad CSS con caracteres no alfanuméricos (p. ej. 'bg-white/5', 'md:w-1/2', 'grid-cols-[3,1fr]', '.border-white/10'): el carácter '/' y los corchetes NO son válidos en selectores. Prefiere atributos estables (id, name, aria-label, data-*) o clases simples sin '/' (p. ej. '#btn-save', '[data-testid="login"]', 'nav.main-menu').
